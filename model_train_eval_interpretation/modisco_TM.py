...
def cli(contrib_file, seq_file):
        for l in range (0, len(contrib_file), 1):
                #raw model scores
                #print(str(sys.argv[1]))
                scores = np.load(str(contrib_file[l])) #"hypothetical_contribution_scores_mean_HASMC_Chol.npz"
                ...
                #save results
                modiscolite.io.save_hdf5("modisco_"+str(contrib_file[l])+".h5", pos_patterns, neg_patterns)
