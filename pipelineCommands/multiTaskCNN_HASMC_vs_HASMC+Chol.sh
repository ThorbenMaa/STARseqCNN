...
setUpComp="diffHASMC_CTRL_vs_Chol"
setUpOne="HASMC_untreatedPilot"
setUpTwo="HASMC_Chol"
motifSource="multitaskCNN_v2"
alecFile="./mpralm/HASMC_Chol-vs-HASMC_untreatedPilot.csv"
...
# get background for fimo
# fasta-get-markov -dna all_seqs.fa all_seq_background.txt
