...
example bash command:   python ./allMotifsWithSignificantEffects/sanityCheck_extract_motifPWM.py --dataBase test.hCWM-PFM.meme --output test.txt
"""
