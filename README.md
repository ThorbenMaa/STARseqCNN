# STARseqCNN
This repository contains and describes code used to train, evaluate, and interprete multi task STARseq CNNs trained on STARseq data from multiple experimental set-ups provided by the Kaikkonen lab.
