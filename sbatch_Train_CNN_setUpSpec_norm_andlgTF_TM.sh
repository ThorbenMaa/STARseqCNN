...
echo teloheac_ctrl_vs_6h_WITHaug_norm+log
echo startInst
...
--holdOut chr8  \
--useAug no_aug  \
--model allseq-CNN_StarSeq_model_Minna_deepSTAR_lr0.01no_augsetUpSpecNorm_lgTF_\(\'mean_HepG2_untreatedPilot\',\ \'mean_TeloHAEC_CTRL\'\)   \
--compare mean_HepG2_untreatedPilot \
--compare mean_TeloHAEC_CTRL
