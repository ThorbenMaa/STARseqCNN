...
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_cell_3T3_diff_CTRL.svg")
plt.close()
plt.scatter(predictions_diff[:,1], input_label_test[:,1], s=1)
plt.title('diff_mean_ccell_3T3_undiff_CTRL'+str(stats.pearsonr(predictions_diff[:,1], input_label_test[:,1])))
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_ccell_3T3_undiff_CTRL.svg")
plt.close()
plt.scatter(predictions_diff[:,2], input_label_test[:,2], s=1)
plt.title('diff_mean_cell_3T3_undiff_TGFB'+str(stats.pearsonr(predictions_diff[:,2], input_label_test[:,2])))
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_cell_3T3_undiff_TGFB.svg")
plt.close()
plt.scatter(predictions_diff[:,3], input_label_test[:,3], s=1)
plt.title('diff_mean_RAW_CTRL'+str(stats.pearsonr(predictions_diff[:,3], input_label_test[:,3])))
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_RAW_CTRL.svg")
plt.close()
plt.scatter(predictions_diff[:,4], input_label_test[:,4], s=1)
plt.title('diff_mean_RAW_IL1B'+str(stats.pearsonr(predictions_diff[:,4], input_label_test[:,4])))
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_RAW_IL1B.svg")
plt.close()
plt.scatter(predictions_diff[:,5], input_label_test[:,5], s=1)
plt.title('diff_mean_cell_3T3_diff_CTRL'+str(stats.pearsonr(predictions_diff[:,5], input_label_test[:,5])))
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_RAW_TGFB.svg")
plt.close()
plt.scatter(predictions_diff[:,6], input_label_test[:,6], s=1)
plt.title('diff_mean_TeloHAEC_CTRL'+str(stats.pearsonr(predictions_diff[:,6], input_label_test[:,6])))
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_TeloHAEC_CTRL.svg")
plt.close()
plt.scatter(predictions_diff[:,7], input_label_test[:,7], s=1)
plt.title('diff_mean_TeloHAEC_IL1b_24h'+str(stats.pearsonr(predictions_diff[:,7], input_label_test[:,7])))
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_TeloHAEC_IL1b_24h.svg")
plt.close()
plt.scatter(predictions_diff[:,8], input_label_test[:,8], s=1)
plt.title('diff_mean_TeloHAEC_IL1b_6h'+str(stats.pearsonr(predictions_diff[:,8], input_label_test[:,8])))
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_TeloHAEC_IL1b_6h.svg")
plt.close()
plt.scatter(predictions_diff[:,9], input_label_test[:,9], s=1)
plt.title('diff_mean_HASMC_untreatedPilot'+str(stats.pearsonr(predictions_diff[:,9], input_label_test[:,9])))
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_HASMC_untreatedPilot.svg")
plt.close()
plt.scatter(predictions_diff[:,10], input_label_test[:,10], s=1)
plt.title('diff_mean_HASMC_Chol'+str(stats.pearsonr(predictions_diff[:,10], input_label_test[:,10])))
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_HASMC_Chol.svg")
plt.close()
plt.scatter(predictions_diff[:,11], input_label_test[:,11], s=1)
plt.title('diff_mean_HepG2_untreatedPilot'+str(stats.pearsonr(predictions_diff[:,11], input_label_test[:,11])))
plt.savefig(str(sys.argv[4])+"_"+str(sys.argv[6])+"_mean_HepG2_untreatedPilot.svg")
plt.close()
