...
@click.option(
    ...
    multiple=True,
    type=str,
    default=["mean_HepG2_untreatedPilot", "mean_TeloHAEC_CTRL"],
...
def cli(counts1_file, counts2_file, seqs_file, mode, hold_out_chrom, use_aug, pretrained_model, setUps_to_compare):
    ...
    if use_aug=="use_aug":
        ...
        setUps_to_compare_list.append(df_IDs_seqs_reg_labels_train["Set up Difference"].to_list() + df_IDs_seqs_reg_labels_train["Set up Diffrence"].to_list())
