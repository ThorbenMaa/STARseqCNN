"""
Description:            This scripts plots Boxplots without outlyers of experimental STARseq activity and differences between set ups for Sequences containing a motif of interest or not. Note that the motifs should be provided by the user
...
Output:                  Boxplots for activities with and without motifs of interest for HepG2 and TeloHEAC_CTRL. 

example bash command:   python ./ExpSetUpSpecificCNN/sanityCheck_modisco_results_diff_HepG2_vs_TeloHEAC_CTRL.py 2023-01-10_22-29-33\ myCounts.minDNAfilt.depthNorm.keepHaps\ -\ starr.haplotypes.oligo1.txt starrseq-all-final-toorder_oligocomposition.csv 2023-01-10_22-29-33\ myCounts.minDNAfilt.depthNorm.keepHaps\ -\ starr.haplotypes.oligo2.txt
...
motivsToCheck=[ "ACAGGAA", "TGAGTCA", "CCCGCCC", "CATTGTT", "ACAATGG", "CTTATCT", "ACGGAAA"]

#define cell type
cellType=["HepG2_untreatedPilot", "TeloHAEC_CTRL"]#"cell_3T3_diff_CTRL", "ccell_3T3_undiff_CTRL", "cell_3T3_undiff_TGFB", "RAW_CTRL" , "RAW_IL1B", "RAW_TGFB", "TeloHAEC_CTRL", "TeloHAEC_IL1b_24h", "TeloHAEC_IL1b_6h", "HASMC_untreatedPilot", "HASMC_Chol", "HepG2_untreatedPilot"]
